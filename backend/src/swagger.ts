      ...
      schemas: {
        ...
        Match: {
          ...
          properties: {
            ...
            playerAId: { type: 'string', nullable: true, description: 'Player A ID (team representative for rating)' },
            playerBId: { type: 'string', nullable: true, description: 'Player B ID (team representative for rating)' },
            participants: {
              type: 'array',
              items: {
                type: 'object',
                properties: {
                  userId: { type: 'string' },
                  team: { type: 'string', enum: ['A', 'B'], nullable: true },
                  userName: { type: 'string', nullable: true },
                },
              },
              description: 'Match participants (team assigned when result is submitted)',
            },
